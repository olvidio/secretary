...
Reúne lo que afecta al centro como entidad: quién puede entrar a llevar sus cuentas, la carga del libro de Excel del que se viene, las partidas del capítulo VII y el alta de otro centro.
...
- **«Ya existe un centro con ese código»**: los códigos no se pueden repetir; elegir otro.
- **«La contraseña debe tener al menos 6 caracteres»**: alargarla.
- **«El usuario debe empezar por letra y tener 2-32 caracteres»**: el alias admite letras, números, punto y guion, y empieza por letra.
- **«Ese correo o usuario ya es una cuenta personal; no puede ser secretario de un centro»**: usar un correo distinto del que esa persona emplea en su libro personal.
- **«El Excel no se importó: …»**: el centro se ha creado, pero el fichero no se ha podido leer. Corregirlo y subirlo desde «Excel de este centro».
