...
Contrasta el libro personal con el general y avisa de dos cosas que se escapan con facilidad: que la vivienda que cada persona paga esté también reflejada en el libro general, y que nadie se haya quedado sin anotar movimientos en algún mes.

## Cómo se usa

1. Al entrar, «Hasta» viene con la fecha de cierre del centro. Se puede cambiar.
2. Pulsar **Ejecutar**.
3. Aparecen dos bloques, cada uno con una marca de correcto o incorrecto y su tabla de detalle.
...
- Si en Nombres una persona está exenta en ciertos meses (por llegada o salida a mitad de curso), esos meses no se le exigen.
