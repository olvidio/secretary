...
Sirve para guardar una copia de seguridad del libro propio y para recuperarla si algo se estropea. La copia incluye los movimientos personales, las categorías creadas por cuenta propia, lo importado del extracto del banco y las fechas de cierre de los meses.

No incluye nada del centro. Restaurar una copia no cambia las cuentas del centro ni los envíos mensuales que el centro ya hubiera aceptado.
...
- El fichero es de tipo `.json` y, al subirlo, no puede pasar de 32 MB.
- Las fechas de los movimientos de la copia tienen que estar dentro de años que el centro tenga abiertos.
...
- **«No existe el fichero de copia indicado»**: la copia ya se había borrado. Recargar la pantalla.
- **«No hay ejercicio para la fecha …»**: la copia contiene movimientos de un año que el centro ya no tiene abierto. Hay que avisar al secretario.
