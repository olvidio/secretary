...
Prepara el presupuesto del libro personal, persona a persona. Cada hoja replica los conceptos del 613 P. Hay una columna con la cifra **calculada** (lo ya anotado más una proyección hasta el fin del ejercicio) y otra en blanco para el **importe** que se quiere presupuestar.
...
- **La columna de esa persona en Previsión sigue a cero**: no se ha guardado esta hoja, o se eligió otra persona.
