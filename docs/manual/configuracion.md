...
- Los tramos de desgravación se pueden cambiar; el primero se llena entre varias personas antes de subir el importe de una sola. El máximo (10 % de la base liquidable, art. 69.1 de la Ley del IRPF) recorta lo que cada uno puede meter en partidas 7 que desgravan: el resto va a las que no desgravan. La base liquidable se escribe en Nombres; si falta, el 111 de la previsión o el ingreso 111 proyectado a fin de año.

## Problemas frecuentes

- **«Fecha inválida»**: las fechas se escriben como año-mes-día o como día/mes/año. Repasar el campo y volver a guardar.
