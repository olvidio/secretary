...
Avanza el mes de trabajo. La fecha de cierre marca hasta dónde están metidos los datos del centro, y es la que las demás pantallas usan como punto de partida.

Es un atajo al mismo dato que aparece en la pantalla de Configuración, para no tener que entrar allí cada mes.

## Cómo se usa

1. Terminar el mes y sacar el resumen 613.
2. Abrir esta pantalla, poner la fecha de cierre del mes siguiente y pulsar «Guardar».
