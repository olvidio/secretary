...
final class RestaurarCopiaSeguridad
{
    ...
    public function ejecutar(array $datos, ?string $ficheroSubido = null): void
    {
        if (empty($datos['confirmar'])) {
            throw new InvalidArgumentException(_("Confirme la restauración con confirmar: true"));
        }
        ...
        if ($nombre === '') {
            throw new InvalidArgumentException(_("Indique un fichero de copia o súbalo"));
        }
