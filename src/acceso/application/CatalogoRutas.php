...
final class CatalogoRutas
{
    ...
    public static function todas(): array
    {
        ...
        $filas = [
            [$p, 'login', 'publico'],
            [$p, 'registro', 'publico'],
            [$p, 'registroEnviado', 'publico'],
            [$p, 'confirmarEmail', 'publico'],
            [$p, 'documentoLegal', 'publico'],
            [$a, 'login', 'publico'],
            [$a, 'registro', 'publico'],
            [$a, 'reenviarVerificacion', 'publico'],
            [$a, 'csrf', 'publico'],
            [$a, 'logout', 'pendiente'],
            ...
            ['src\\personal\\infrastructure\\http\\BancoPersonalController', 'guardarPreferencia', 'persona'],
            ...
            ['src\\administracion\\infrastructure\\http\\AdminCentroController', 'delete', 'admin'],
            ['src\\administracion\\infrastructure\\http\\AdminUsuarioController', 'list', 'admin'],
            ['src\\administracion\\infrastructure\\http\\AdminUsuarioController', 'delete', 'admin'],
            [$p, 'admin', 'admin'],
            [$p, 'adminPlanes', 'admin'],
            [$p, 'adminCentros', 'admin'],
            [$p, 'adminUsuarios', 'admin'],
            ...
            ['src\\personas\\infrastructure\\http\\VinculoCentroController', 'listarYo', 'persona-cuenta'],
            ['src\\personas\\infrastructure\\http\\VinculoCentroController', 'centrosDisponibles', 'persona-cuenta'],
            ['src\\personas\\infrastructure\\http\\VinculoCentroController', 'solicitarYo', 'persona-cuenta'],
            ['src\\personas\\infrastructure\\http\\VinculoCentroController', 'desvincularYo', 'persona-cuenta'],
            ...
            ['src\\cierre\\infrastructure\\http\\CierreController', 'regularizar', 'centro'],
            ...
            ['src\\envio_dl\\infrastructure\\http\\EnvioDlController', 'proponer', 'centro'],
            ['src\\envio_dl\\infrastructure\\http\\EnvioDlController', 'confirmar', 'centro'],
