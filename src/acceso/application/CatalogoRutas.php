...
final class CatalogoRutas
{
    ...
    public static function todas(): array
    {
        ...
        $filas = [
            ...
            ['src\\acceso\\infrastructure\\http\\PreferenciaController', 'resumenBaja', 'autenticado'],
            ['src\\acceso\\infrastructure\\http\\PreferenciaController', 'solicitarBaja', 'autenticado'],
            [$p, 'cuenta', 'autenticado'],
            [$p, 'totpActivar', 'pendiente'],
            [$p, 'totpVerificar', 'pendiente'],
            [$p, 'elegirCentro', 'autenticado'],
            [$p, 'elegirCuenta', 'publico'],
            ...
            ['src\\administracion\\infrastructure\\http\\AdminUsuarioController', 'previewDelete', 'admin'],
            ['src\\administracion\\infrastructure\\http\\AdminUsuarioController', 'delete', 'admin'],
            ['src\\administracion\\infrastructure\\http\\AdminUsuarioController', 'reactivate', 'admin'],
            ['src\\administracion\\infrastructure\\http\\AdminLegalController', 'buscar', 'admin'],
            ['src\\administracion\\infrastructure\\http\\AdminLegalController', 'ver', 'admin'],
            ['src\\administracion\\infrastructure\\http\\AdminLegalController', 'exportar', 'admin'],
            [$p, 'admin', 'admin'],
            [$p, 'adminPlanes', 'admin'],
            ...
            ['src\\apuntes\\infrastructure\\http\\BancoCentroController', 'bancos', 'centro'],
            ['src\\apuntes\\infrastructure\\http\\BancoCentroController', 'guardarPreferencia', 'centro'],
            ['src\\apuntes\\infrastructure\\http\\BancoCentroController', 'pendientes', 'centro'],
            ['src\\apuntes\\infrastructure\\http\\BancoCentroController', 'importar', 'centro'],
            ['src\\apuntes\\infrastructure\\http\\BancoCentroController', 'categorizar', 'centro'],
