...
final class CatalogoConceptos
{
    ...
    public static function todos(): array
    {
        $p = [
            ...
            ['211', 'Vivienda general', '211 Vivienda general: cuadra con G/11 (cierre automático o imputación puntual a generales)', 'gasto', 51],
            ['212', 'Vivienda personal', '212 Vivienda personal: gastos de casa propios, sin contrapartida G/11', 'gasto', 52],
