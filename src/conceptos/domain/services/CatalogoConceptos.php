...
final class CatalogoConceptos
{
    ...
    public static function todos(): array
    {
        $p = [
            ...
            ['21', 'Vivienda', '21 Vivienda: aportación a los gastos generales de la casa (cuadra con G/11)', 'gasto', 50],
            ['212', 'Vivienda personal', '212 Vivienda personal: gastos de vivienda propios, como ordinarios (no cuentan en G/11)', 'gasto', 52],
